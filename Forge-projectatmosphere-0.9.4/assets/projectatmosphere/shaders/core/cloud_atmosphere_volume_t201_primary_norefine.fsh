...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_DESC_PRECOMPUTE 1, PA_ARM_PRIMARY_FIELD_DENSITY 1, PA_ARM_NO_REFINE 1
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_DESC_PRECOMPUTE 1
#define PA_ARM_PRIMARY_FIELD_DENSITY 1
#define PA_ARM_NO_REFINE 1
