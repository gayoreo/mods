...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_DESC_PRECOMPUTE 1, PA_ARM_RAIN_GATE_REJECT_ALL 1, PA_ARM_SHAFT_RUNTIME_FALSE 1
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_DESC_PRECOMPUTE 1
#define PA_ARM_RAIN_GATE_REJECT_ALL 1
#define PA_ARM_SHAFT_RUNTIME_FALSE 1
