...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_DESC_PRECOMPUTE 1, PA_PRIMARY_DINTERP 1, PA_PRIMARY_AUDIT 1
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_DESC_PRECOMPUTE 1
#define PA_PRIMARY_DINTERP 1
#define PA_PRIMARY_AUDIT 1
...
uniform int PaLightAuditOutput;
