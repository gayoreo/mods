...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_FOOTPRINT 0.75, PA_ARM_FOOTPRINT_MAX 4.0, PA_ARM_EARLY_TERM 0.045, PA_ARM_DETAIL_FOOTPRINT 1.0, PA_ARM_LIGHT_STEPS 4, PA_ARM_DESC_PRECOMPUTE 1, PA_ARM_PROBE_NO_DETAIL 1
#version 150
...
#define PA_ARM_PROBE_NO_DETAIL 1
