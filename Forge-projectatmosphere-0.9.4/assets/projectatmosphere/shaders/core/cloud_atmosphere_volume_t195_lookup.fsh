...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_DESC_PRECOMPUTE 1, PA_ARM_NO_PROBE 1, PA_ARM_FIELD_LOOKUP 13
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_DESC_PRECOMPUTE 1
#define PA_ARM_NO_PROBE 1
#define PA_ARM_FIELD_LOOKUP 13
