...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_FOOTPRINT 0.75, PA_ARM_FOOTPRINT_MAX 3.0, PA_ARM_EARLY_TERM 0.045, PA_ARM_DETAIL_FOOTPRINT 1.0, PA_ARM_LIGHT_STEPS 4
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_FOOTPRINT 0.75
#define PA_ARM_FOOTPRINT_MAX 3.0
