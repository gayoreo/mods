...
// Variant defines: PA_ARM_DESC_PRECOMPUTE 1, PA_RAIN_MASK_OUTPUT 1, PA_ARM_NO_RAIN_SEGMENT 1, PA_RAIN_SPLIT_COMPOSITE 1
#version 150
#define PA_ARM_DESC_PRECOMPUTE 1
#define PA_RAIN_MASK_OUTPUT 1
#define PA_ARM_NO_RAIN_SEGMENT 1
#define PA_RAIN_SPLIT_COMPOSITE 1
