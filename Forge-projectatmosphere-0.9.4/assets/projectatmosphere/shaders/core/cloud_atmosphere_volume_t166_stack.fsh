...
// Variant defines: PA_PRECIPITATION_ABSENT 1, PA_ARM_LIGHT_CHEAP 1, PA_ARM_LIGHT_NO_DETAIL 1, PA_ARM_LIGHT_STEPS 4, PA_ARM_LIGHT_EARLY_OUT 3.0, PA_ARM_DISTANCE_STEP 1.0, PA_ARM_DISTANCE_LOD 0.35
#version 150
#define PA_PRECIPITATION_ABSENT 1
#define PA_ARM_LIGHT_CHEAP 1
#define PA_ARM_LIGHT_NO_DETAIL 1
#define PA_ARM_LIGHT_STEPS 4
#define PA_ARM_LIGHT_EARLY_OUT 3.0
#define PA_ARM_DISTANCE_STEP 1.0
#define PA_ARM_DISTANCE_LOD 0.35
