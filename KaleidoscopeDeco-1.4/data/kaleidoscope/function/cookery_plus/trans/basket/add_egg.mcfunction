data modify entity @s data.basket.type set value "egg"
...
execute if score @s kaleidoscope_temp matches 3 run advancement grant @a[tag=dc_click_temp] only kaleidoscope:cookery_plus/basket
